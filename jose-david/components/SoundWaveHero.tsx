...
const BANDS = [
  ...
  [  0.22,  3.2,  0.24,  1.6, '#e0d9ff',   0.95,  1.8 ],
  [  0.55,  2.5,  0.19,  1.2, '#c4b5fd',   0.80,  1.5 ],
  [  0.90,  4.1,  0.14,  1.0, '#a78bfa',   0.65,  1.2 ],
  [  1.28,  2.9,  0.09,  1.5, '#818cf8',   0.50,  1.0 ],
  [  1.68,  3.7,  0.06,  0.8, '#6366f1',   0.35,  0.8 ],
  [  2.12,  2.1,  0.03,  1.8, '#4f46e5',   0.22,  0.6 ],
] as const;
